...
class DadosCandidatoModelSerializer(serializers.ModelSerializer):
    class Meta:
...
class HabilidadeModelSerializer(serializers.ModelSerializer):
    class Meta:
        model = Habilidade
        fields = "__all__"
        read_only_fields = ["id", "usuario"]
...
class ExperienciaAcademicaModelSerializer(serializers.ModelSerializer):
    class Meta:
...
class ExperienciaProfissionalModelSerializer(serializers.ModelSerializer):
    class Meta:
...
class IdiomaModelSerializer(serializers.ModelSerializer):
    class Meta:
        model = Idioma
        fields = "__all__"
        read_only_fields = ["id", "usuario"]
...
class ConquistaModelSerializer(serializers.ModelSerializer):
    class Meta:
        model = Conquista
        fields = "__all__"
        read_only_fields = ["id", "usuario"]
...
class CurriculoModelSerializer(serializers.ModelSerializer):
    class Meta:
        model = Curriculo
        fields = "__all__"
        read_only_fields = ["id", "usuario"]
